...
INSERT INTO `action` (`action_id`, `name`, `module`, `function`, `show_on_menu`, `parent`, `sort`) VALUES
	...
	(65, 'sales per district', 'sales', 'district', 2, 21, 0);
...
CREATE TABLE IF NOT EXISTS `area` (
  ...
  PRIMARY KEY (`area_id`),
  KEY `FK_area_district` (`district_id`),
  CONSTRAINT `FK_area_district` FOREIGN KEY (`district_id`) REFERENCES `district` (`district_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1;

-- Dumping data for table jabee123_vme.area: ~2 rows (approximately)
/*!40000 ALTER TABLE `area` DISABLE KEYS */;
INSERT INTO `area` (`area_id`, `area_name`, `area_code`, `district_id`) VALUES
	(1, 'manila', 'mnl1', 2),
	(2, 'cebu', 'ceb1', 3),
	(3, 'north', 'mnl2', 2),
	(4, 'lapulaput', 'ceb2', 3),
...
INSERT INTO `batch` (`batch_id`, `batch_readable_id`, `item_id`, `user_id`, `supplier_id`, `count`, `access_type`, `sold_count`, `expire_count`, `return_count`, `buy`, `sell`, `lot_number`, `on_cavite_warehouse`, `recieve_date`, `expire_date`, `status`) VALUES
	...
	(3, 'b-c0001', 3, 1, 1, 10000, 'recieved', 2, 0, 0, 100, 120, 'r9-c1', 'N', '2015-01-31', '2018-01-31', 'enabled'),
	(4, 'b-n0001', 1, 1, 2, 1000000, 'recieved', 251, 0, 1000, 3, 4, 'r99-c11', 'N', '2015-01-31', '2020-01-22', 'enabled'),
...
INSERT INTO `logs` (`log_id`, `ip_address`, `useragent`, `user_id`, `role_id`, `action`, `result`, `target`, `url`, `sql`, `datetime`) VALUES
	...
	(341, '::1', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/5', '1', 1, 'login', 'success', 'login_form', 'http://localhost/vmv2/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  \'1\'', '2015-12-10 16:08:33'),
	(342, '::1', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/5', '1', 1, 'login', 'success', 'login_form', 'http://localhost/vmv2/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  \'1\'', '2015-12-11 15:39:27'),
	(343, '::1', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/5', '1', 1, 'login', 'success', 'login_form', 'http://localhost/vmv2/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  \'1\'', '2015-12-12 18:26:14');
...
INSERT INTO `orders` (`order_id`, `sales_type`, `msr_client_id`, `order_date`, `discount`, `discount_type`, `form_number`, `transaction_type`, `si_no`, `dr_date`, `payment_type`, `return_id`, `cancel_date`, `approved_pre`, `approved_post`, `client_name`, `client_address`, `product_id`, `generic_name`, `product_batch`, `quantity`, `price`, `expire_date`, `discount_amount`, `subtotal`, `vat_sales`, `vat_12`, `total_amount`, `free_goods`) VALUES
	...
	(10, '1', 7, '2015-12-12 19:46:49', 0, 'percentage', 'dasdsa', 'DR', 'sda', '12/11/2015', '30_days', 0, NULL, 1, 1, '0', '0', '1', 'paracetamol', '4', '1', '4', '2020-01-22', '0', '4', '3.57', '0.43', '4', 1),
	(11, '1', 1, '2015-12-12 19:47:31', 0, 'percentage', '123', 'DR', 'qwe2qs', '12/11/2015', '30_days', 0, NULL, 1, 1, '0', '0', '3', 'antisipon gamotsis', '3', '2', '120', '2018-01-31', '0', '240', '214.29', '25.71', '240', 213);
...
INSERT INTO `payment` (`payment_id`, `amount`, `payment_type`, `bank`, `check_number`, `check_full_amount`, `datetime`, `datetime_collected`, `date_of_cheque`, `status`, `msr_client_id`, `pr_or_number`, `date_of_pr_or`, `dr_applied`) VALUES
	...
	(8, 213123, 'cash', '', '', '', '2015-12-12 20:09:55', '0000-00-00', '', 'Unpaid', NULL, 0, '12/11/2015', 'sada2');
...
-- Dumping data for table jabee123_vme.user: ~90 rows (approximately)
...
INSERT INTO `user` (`user_id`, `first_name`, `middle_name`, `last_name`, `password`, `email`, `address`, `contact_person`, `contact_number`, `area_id`, `quota`, `role_id`, `district_id`, `status`, `civil_status`, `note`) VALUES
	...
	(25, 'JEROME', '', 'VALERIO', 'jeromevalerio', 'jeromevalerio@email.com', NULL, NULL, NULL, 2, 0, 6, 3, 'active', 'single', NULL),
	(26, 'MILLISCENT', 'BITANGCOL', 'DALUSONG', 'milly', 'milliscent.bitangcol@yahoo.com', NULL, NULL, NULL, 3, 550000, 6, 2, 'active', 'single', NULL),
	(27, 'CHERRYL ANNE', 'GAZA', 'ALBERTO', 'anne', 'annalberto04@gmail.com', NULL, NULL, NULL, 1, 550000, 6, 2, 'active', 'single', NULL),
	(29, 'DONDEE', '', 'EUSEBIO', 'dondeeeusebio', 'dondeeeeusebio@email.com', NULL, NULL, NULL, 3, 0, 6, 1, 'active', 'single', NULL),
	...
	(109, 'KRISTIAN PAUL', '', 'ATIENZA', 'paulatienza', 'paulatienza@email.com', NULL, NULL, NULL, 3, 0, 6, 1, 'active', 'single', NULL),
	(111, 'JANE', '', 'MORILLO', 'janemorillo', 'janemorillo@email.com', NULL, NULL, NULL, 2, 0, 6, 1, 'active', 'single', NULL);
