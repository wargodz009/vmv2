...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 21, 2015 at 10:48 AM
...
--
-- Database: `jabee123_vme`
--

-- --------------------------------------------------------

--
-- Table structure for table `acknowledgement_reciept`
--
...
--
-- Dumping data for table `acknowledgement_reciept`
--

INSERT INTO `acknowledgement_reciept` (`reciept_id`, `name`, `address`, `date`, `remarks`) VALUES
(1, 'dsadas', 'dasd', '2015-08-06', 0x64736164);
...
--
-- Table structure for table `ar_old`
--
...
INSERT INTO `logs` (`log_id`, `ip_address`, `useragent`, `user_id`, `role_id`, `action`, `result`, `target`, `url`, `sql`, `datetime`) VALUES
(208, '180.191.143.120', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-06-19 02:21:28'),
(209, '110.55.3.12', 'Mozilla/5.0 (iPhone; CPU iPhone OS 8_3 like Mac OS', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-06-19 02:40:16'),
(210, '180.191.143.120', 'Mozilla/5.0 (Windows NT 6.1; WOW64; rv:38.0) Gecko', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-06-19 02:43:21'),
(211, '180.191.142.246', 'Mozilla/5.0 (Windows NT 6.1; WOW64; rv:38.0) Gecko', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-06-19 15:41:54'),
(212, '103.14.63.166', 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-06-20 03:55:06'),
(213, '103.14.63.166', 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-06-21 09:54:42'),
(214, '103.14.63.166', 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-06-21 12:21:34'),
(215, '119.95.239.144', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-06-25 11:01:45'),
(216, '112.209.172.247', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-07-01 04:18:41'),
(217, '112.209.172.247', 'Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (K', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-07-01 07:54:45'),
(218, '112.209.172.247', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '0', 0, 'login', 'fail', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`user`)\nWHERE `email` =  ''ADMIN@EMa', '2015-07-07 07:50:18'),
(219, '112.209.172.247', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-07-07 07:50:32'),
(220, '112.209.172.247', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-07-10 08:22:27'),
(221, '112.209.172.247', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-07-13 08:10:45'),
(222, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-07-21 03:47:49'),
(223, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '59', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 03:58:05'),
(224, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '60', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 04:06:12'),
(225, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '61', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 05:09:08'),
(226, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'login', 'fail', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`user`)\nWHERE `email` =  ''ADMIN@EMA', '2015-07-21 05:09:50'),
(227, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-07-21 05:10:02'),
(228, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '62', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 05:14:21'),
(229, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '63', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 05:16:50'),
(230, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '64', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 05:22:59'),
(231, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '65', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 05:25:40'),
(232, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '66', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 05:29:07'),
(233, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '67', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 05:32:52'),
(234, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-07-21 05:36:29'),
(235, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '68', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 05:39:54'),
(236, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '69', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 05:44:13'),
(237, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '70', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 05:45:47'),
(238, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '71', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 05:46:54'),
(239, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'edit_user', 'success', '71', 'http://vmephilmedica.com/vme/index.php/user/client', 'UPDATE `user` SET `first_name` = ''MARIE'', `middle_', '2015-07-21 05:47:07'),
(240, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'edit_user', 'success', '65', 'http://vmephilmedica.com/vme/index.php/user/client', 'UPDATE `user` SET `first_name` = ''IRMA'', `middle_n', '2015-07-21 05:47:51'),
(241, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'edit_user', 'success', '66', 'http://vmephilmedica.com/vme/index.php/user/client', 'UPDATE `user` SET `first_name` = ''JUN'', `middle_na', '2015-07-21 05:48:25'),
(242, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'edit_user', 'success', '68', 'http://vmephilmedica.com/vme/index.php/user/client', 'UPDATE `user` SET `first_name` = ''KAREN'', `middle_', '2015-07-21 05:49:05'),
(243, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '72', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 05:51:23'),
(244, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '73', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 05:58:00'),
(245, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '74', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 05:59:56'),
(246, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '75', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 06:02:30'),
(247, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '76', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 06:04:01'),
(248, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '77', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 06:06:05'),
(249, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '78', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 06:09:44'),
(250, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '79', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 06:14:08'),
(251, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '80', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 06:18:35'),
(252, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '81', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 06:23:02'),
(253, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '82', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 06:24:59'),
(254, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '83', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 06:27:19'),
(255, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '84', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 06:31:28'),
(256, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '85', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 06:34:02'),
(257, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'edit_user', 'success', '85', 'http://vmephilmedica.com/vme/index.php/user/client', 'UPDATE `user` SET `first_name` = ''DR. EDMUNDO'', `m', '2015-07-21 06:36:24'),
(258, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '86', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 06:37:37'),
(259, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '87', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 06:38:39'),
(260, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '88', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 06:40:29'),
(261, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '89', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 06:42:11'),
(262, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'edit_user', 'success', '88', 'http://vmephilmedica.com/vme/index.php/user/client', 'UPDATE `user` SET `first_name` = ''DR. LYNMAN'', `mi', '2015-07-21 06:43:51'),
(263, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '90', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 06:48:37'),
(264, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '91', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 06:50:06'),
(265, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '92', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 06:51:36'),
(266, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '93', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 06:53:49'),
(267, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '94', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 06:58:55'),
(268, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '95', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 07:00:44'),
(269, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '96', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 07:05:56'),
(270, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '97', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 07:07:03'),
(271, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '98', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 07:21:00'),
(272, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '99', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 07:22:36'),
(273, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '100', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 07:24:16'),
(274, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'edit_user', 'success', '100', 'http://vmephilmedica.com/vme/index.php/user/client', 'UPDATE `user` SET `first_name` = ''DRA. VIVIAN'', `m', '2015-07-21 07:28:16'),
(275, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '101', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 07:31:24'),
(276, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '102', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 07:34:23'),
(277, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '103', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 07:36:49'),
(278, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '104', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 07:38:44'),
(279, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '105', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 07:41:08'),
(280, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '106', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 07:44:14'),
(281, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '107', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 07:45:23'),
(282, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '108', 'http://vmephilmedica.com/vme/index.php/user/client', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-07-21 07:46:53'),
(283, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'edit_msrclient', 'success', '28', 'http://vmephilmedica.com/vme/index.php/msr_client/', 'DELETE FROM `msr_client`\nWHERE `msr_id` =  ''28''', '2015-07-21 07:49:00'),
(284, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'edit_msrclient', 'success', '28', 'http://vmephilmedica.com/vme/index.php/msr_client/', 'DELETE FROM `msr_client`\nWHERE `msr_id` =  ''28''', '2015-07-21 07:49:04'),
(285, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'edit_msrclient', 'success', '26', 'http://vmephilmedica.com/vme/index.php/msr_client/', 'DELETE FROM `msr_client`\nWHERE `msr_id` =  ''26''', '2015-07-21 07:51:22'),
(286, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'edit_msrclient', 'success', '27', 'http://vmephilmedica.com/vme/index.php/msr_client/', 'DELETE FROM `msr_client`\nWHERE `msr_id` =  ''27''', '2015-07-21 07:51:34'),
(287, '112.209.234.200', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'edit_user', 'success', '25', 'http://vmephilmedica.com/vme/index.php/user/employ', 'UPDATE `user` SET `first_name` = ''MARY ANN'', `midd', '2015-07-21 08:16:54'),
(288, '122.3.254.166', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) Ap', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-07-21 09:51:44'),
(289, '112.209.222.202', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-07-27 00:39:52'),
(290, '112.209.222.202', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-07-27 05:12:08'),
(291, '103.14.63.210', 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-07-27 08:07:03'),
(292, '112.209.222.202', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-07-28 00:28:35'),
(293, '112.209.222.202', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-07-28 09:08:34'),
(294, '112.209.222.202', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-07-29 02:16:22'),
(295, '112.209.222.202', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'edit_user', 'success', '27', 'http://vmephilmedica.com/vme/index.php/user/employ', 'UPDATE `user` SET `first_name` = ''CHERRYL ANNE'', `', '2015-07-29 03:23:43'),
(296, '112.209.222.202', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'edit_user', 'success', '26', 'http://vmephilmedica.com/vme/index.php/user/employ', 'UPDATE `user` SET `first_name` = ''MILLISCENT'', `mi', '2015-07-29 03:24:56'),
(297, '112.209.222.202', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-07-29 05:42:23'),
(298, '112.209.222.202', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-08-03 08:40:31'),
(299, '125.212.123.71', 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-08-06 10:09:23'),
(300, '119.95.177.73', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-08-07 04:28:07'),
(301, '119.95.177.73', 'Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (K', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-08-07 10:49:36'),
(302, '112.209.255.239', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-08-25 00:36:16'),
(303, '112.209.255.239', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'delete_user', 'success', NULL, 'http://vmephilmedica.com/vme/index.php/user/employ', 'DELETE FROM `user`\nWHERE `user_id` =  ''28'' LIMIT 1', '2015-08-25 00:40:45'),
(304, '112.209.255.239', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '109', 'http://vmephilmedica.com/vme/index.php/user/employ', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-08-25 00:42:23'),
(305, '112.209.255.239', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '110', 'http://vmephilmedica.com/vme/index.php/user/employ', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-08-25 00:42:23'),
(306, '112.209.255.239', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'add_user', 'success', '111', 'http://vmephilmedica.com/vme/index.php/user/employ', 'INSERT INTO `user` (`first_name`, `middle_name`, `', '2015-08-25 00:43:27'),
(307, '112.209.255.239', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'delete_user', 'success', NULL, 'http://vmephilmedica.com/vme/index.php/user/employ', 'DELETE FROM `user`\nWHERE `user_id` =  ''110'' LIMIT ', '2015-08-25 00:43:47'),
(308, '112.209.255.239', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'edit_user', 'success', '111', 'http://vmephilmedica.com/vme/index.php/user/employ', 'UPDATE `user` SET `first_name` = ''JANE'', `middle_n', '2015-08-25 00:44:05'),
(309, '112.209.255.239', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'edit_user', 'success', '25', 'http://vmephilmedica.com/vme/index.php/user/employ', 'UPDATE `user` SET `first_name` = ''JEROME'', `middle', '2015-08-25 00:45:32'),
(310, '112.209.255.239', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'edit_user', 'success', '109', 'http://vmephilmedica.com/vme/index.php/user/employ', 'UPDATE `user` SET `first_name` = ''KRISTIAN PAUL'', ', '2015-08-25 00:45:46'),
(311, '112.209.255.239', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'edit_user', 'success', '29', 'http://vmephilmedica.com/vme/index.php/user/employ', 'UPDATE `user` SET `first_name` = ''DONDEE'', `middle', '2015-08-25 00:47:48'),
(312, '112.209.255.239', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'edit_user', 'success', '27', 'http://vmephilmedica.com/vme/index.php/user/employ', 'UPDATE `user` SET `first_name` = ''CHERRYL ANNE'', `', '2015-08-25 00:49:10'),
(313, '112.209.255.239', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-08-25 08:28:15'),
(314, '112.209.255.239', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-08-26 00:35:28'),
(315, '112.209.255.239', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-08-26 05:33:45'),
(316, '112.198.77.53', 'Mozilla/5.0 (Linux; Android 4.4.2; GT-I9505 Build/', '0', 0, 'login', 'fail', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`user`)\nWHERE `email` =  ''admin@ema', '2015-08-27 13:18:56'),
(317, '112.198.77.53', 'Mozilla/5.0 (Linux; Android 4.4.2; GT-I9505 Build/', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-08-27 13:19:14'),
(318, '112.198.83.118', 'Mozilla/5.0 (Linux; Android 4.4.2; GT-I9505 Build/', '1', 1, 'logout', 'success', 'logout_form', 'http://vmephilmedica.com/vme/index.php/signout', '0', '2015-08-27 14:08:18'),
(319, '112.209.255.239', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-09-03 01:18:06'),
(320, '121.97.142.4', 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/53', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-09-07 22:58:16'),
(321, '180.191.138.246', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/5', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-09-10 05:38:31'),
(322, '180.191.143.213', 'Mozilla/5.0 (iPad; CPU OS 8_4 like Mac OS X) Apple', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-09-14 04:17:33'),
(323, '180.191.143.213', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/5', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-09-14 04:43:27'),
(324, '180.191.143.213', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/5', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-09-14 08:04:24'),
(325, '180.191.143.213', 'Mozilla/5.0 (iPad; CPU OS 8_4 like Mac OS X) Apple', '1', 1, 'login', 'success', 'login_form', 'http://vmephilmedica.com/vme/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-09-14 08:05:26'),
(326, '::1', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/5', '1', 1, 'login', 'success', 'login_form', 'http://localhost/vmv2/index.php/signin', 'SELECT *\nFROM (`role`)\nWHERE `role_id` =  ''1''', '2015-09-21 01:28:30'),
(327, '::1', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/5', '1', 1, 'edit_user', 'success', '109', 'http://localhost/vmv2/index.php/user/employee/upda', 'UPDATE `user` SET `first_name` = ''KRISTIAN PAUL'', ', '2015-09-21 01:36:39'),
(328, '::1', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/5', '1', 1, 'edit_user', 'success', '111', 'http://localhost/vmv2/index.php/user/employee/upda', 'UPDATE `user` SET `first_name` = ''JANE'', `middle_n', '2015-09-21 01:36:50'),
(329, '::1', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/5', '1', 1, 'edit_user', 'success', '15', 'http://localhost/vmv2/index.php/user/employee/upda', 'UPDATE `user` SET `first_name` = ''accountant'', `mi', '2015-09-21 01:37:06'),
(330, '::1', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/5', '1', 1, 'edit_user', 'success', '14', 'http://localhost/vmv2/index.php/user/employee/upda', 'UPDATE `user` SET `first_name` = ''warehouseman'', `', '2015-09-21 01:37:17'),
(331, '::1', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/5', '1', 1, 'edit_user', 'success', '20', 'http://localhost/vmv2/index.php/user/employee/upda', 'UPDATE `user` SET `first_name` = ''hrname'', `middle', '2015-09-21 01:37:27'),
(332, '::1', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/5', '1', 1, 'edit_user', 'success', '24', 'http://localhost/vmv2/index.php/user/employee/upda', 'UPDATE `user` SET `first_name` = ''DEXTER'', `middle', '2015-09-21 01:37:43'),
(333, '::1', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/5', '1', 1, 'edit_user', 'success', '26', 'http://localhost/vmv2/index.php/user/employee/upda', 'UPDATE `user` SET `first_name` = ''MILLISCENT'', `mi', '2015-09-21 01:38:05'),
(334, '::1', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/5', '1', 1, 'edit_user', 'success', '14', 'http://localhost/vmv2/index.php/user/employee/upda', 'UPDATE `user` SET `first_name` = ''warehouseman'', `', '2015-09-21 01:38:24'),
(335, '::1', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/5', '1', 1, 'edit_user', 'success', '20', 'http://localhost/vmv2/index.php/user/employee/upda', 'UPDATE `user` SET `first_name` = ''hrname'', `middle', '2015-09-21 01:38:36'),
(336, '::1', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/5', '1', 1, 'edit_user', 'success', '15', 'http://localhost/vmv2/index.php/user/employee/upda', 'UPDATE `user` SET `first_name` = ''accountant'', `mi', '2015-09-21 01:38:48'),
(337, '::1', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/5', '1', 1, 'edit_user', 'success', '27', 'http://localhost/vmv2/index.php/user/employee/upda', 'UPDATE `user` SET `first_name` = ''CHERRYL ANNE'', `', '2015-09-21 01:38:58'),
(338, '::1', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/5', '1', 1, 'edit_user', 'success', '25', 'http://localhost/vmv2/index.php/user/employee/upda', 'UPDATE `user` SET `first_name` = ''JEROME'', `middle', '2015-09-21 01:39:11'),
(339, '::1', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/5', '1', 1, 'edit_user', 'success', '26', 'http://localhost/vmv2/index.php/user/employee/upda', 'UPDATE `user` SET `first_name` = ''MILLISCENT'', `mi', '2015-09-21 01:39:52');
...
(1, '1', 1, '2015-01-31 09:16:53', 0, 'percentage', 'so-00001', 'DR', '', '', '30_days', 1, NULL, 1, 1, 'east avenue medical center', 'east avenue quezon city', '1', 'paracetamol', '4', '1000', '4', '0', '0', '4000', '3520', '480', '4000', 0),
(2, '2', 2, '2015-01-31 09:59:23', 10, 'percentage', 'so-0002', 'DR', '', '', '30_days', 0, NULL, 1, 1, 'north fairview general hospital', 'north fairview quezon city', '2', 'antisakit ulosis', '2', '1000', '3', '0', '0', '3000', '2640', '360', '2700', 0),
(3, '1', 1, '2015-03-10 17:21:01', 10, '', 'so001', 'DR', 'sdsd011', '10201020', '30_days', 0, NULL, 1, 1, 'east avenue medical center', 'east avenue quezon city', '1', 'paracetamol', '4', '100', '4', '2020-01-22', '10', '400', '352', '48', '390', 0),
(4, '1', 1, '2015-03-27 06:09:59', 0, 'percentage', '456', 'DR', '456', '03/27/2015', '30_days', 0, NULL, 1, 1, 'east avenue medical center', 'east avenue quezon city', '6', 'CEFTRIAXONE SODIUM', '6', '40', '480', '2017-06-30', '0', '19200', '16896', '2304', '19200', 0),
(5, '1', 1, '2015-04-16 08:35:30', 0, 'percentage', '12345', 'DR', '25606', '04/01/2015', '30_days', 0, NULL, 1, 1, 'east avenue medical center', 'east avenue quezon city', '1', 'paracetamol', '4', '50', '4', '2020-01-22', '0', '200', '176', '24', '200', 0),
(6, '1', 2, '2015-04-16 08:38:06', 30, '', '12346', 'DR', '25404', '04/02/2015', '30_days', 0, NULL, 1, 1, 'north fairview general hospital', 'north fairview quezon city', '6', 'CEFTRIAXONE SODIUM', '6', '100', '693', '2017-06-30', '30', '69300', '60984', '8316', '69270', 0),
(7, '1', 13, '2015-06-07 13:10:10', 0, 'percentage', '12345', 'DR', '4286', '06/04/2015', '30_days', 0, NULL, 1, 1, 'CASTRO MATERNITY HOSP. & MED. CENTER INC.', 'M. Ponce St., Tibag, Baliuag, Bulacan', '6', 'CEFTRIAXONE SODIUM', '6', '10', '693', '2017-06-30', '0', '6930', '6098.4', '831.6', '6930', 0),
(9, '1', 8, '2015-09-21 03:49:11', 0, 'percentage', 'sada2', 'DR', '1w3', '09/21/2015', '30_days', 0, NULL, 1, 1, '0', '0', '1', 'paracetamol', '4', '100', '4', '2020-01-22', '0', '400', '357.14', '42.86', '400', 1);
...
(1, 1, NULL, 1000, 'near expiry', '2015-01-31 09:51:06', 0, NULL, NULL, NULL, NULL);
...
(4, 2000, 'cheque', 'BDO', '00014264689', '', '2015-08-07 10:58:41', '0000-00-00', '08/13/2015', 'Unpaid', 1, 56789, '08/05/2015', '12345'),
(5, 10000, 'cash', '', '', '', '2015-08-26 01:02:16', '0000-00-00', '', 'Unpaid', 1, 98256, '08/27/2015', 'so-00001'),
(6, 4500, 'cash', '', '', '', '2015-08-27 13:21:18', '0000-00-00', '', 'Unpaid', 1, 24690, '08/14/2015', NULL),
(7, 1000, 'cash', '', '', '', '2015-09-21 04:49:30', '0000-00-00', '', 'Unpaid', NULL, 323232, '09/21/2015', 'sada2');
...
(1, 'admin', 'admin', 'admin', 'admin', 'admin@email.com', 'dsadasd', NULL, NULL, 'SL9 - Office account', 100000, 1, 1, 'active', 'single', NULL),
(14, 'warehouseman', 'warehouseman', 'warehouseman', 'warehouseman', 'warehouseman@email.com', 'fdggdfgdf', NULL, NULL, 'SL9 - Office account', 0, 3, 2, 'active', 'single', NULL),
(15, 'accountant', 'accountant', 'accountant', 'accountant', 'accountant@email.com', 'cxvxvxcvx', NULL, NULL, 'SL9 - Office account', 0, 2, 2, 'active', 'single', NULL),
(20, 'hrname', 'hrmnmae', 'hrlname', 'hr', 'hr@email.com', 'uiyyuiuyi', NULL, NULL, 'SL9 - Office account', 0, 4, 2, 'active', 'single', NULL),
(24, 'DEXTER', '', 'BALLESTER', 'dexter', 'magdalo_56@yahoo.com', NULL, NULL, NULL, 'CL1 - Bulacan', 800000, 6, 2, 'active', 'single', NULL),
(25, 'JEROME', '', 'VALERIO', 'jeromevalerio', 'jeromevalerio@email.com', NULL, NULL, NULL, 'NL1- Pangasinan', 0, 6, 3, 'active', 'single', NULL),
(26, 'MILLISCENT', 'BITANGCOL', 'DALUSONG', 'milly', 'milliscent.bitangcol@yahoo.com', NULL, NULL, NULL, 'CL3 - Nueva ecija', 550000, 6, 2, 'active', 'single', NULL),
(27, 'CHERRYL ANNE', 'GAZA', 'ALBERTO', 'anne', 'annalberto04@gmail.com', NULL, NULL, NULL, 'CL2 - Pampanga', 550000, 6, 2, 'active', 'single', NULL),
(29, 'DONDEE', '', 'EUSEBIO', 'dondeeeusebio', 'dondeeeeusebio@email.com', NULL, NULL, NULL, 'South Luzon', 0, 6, 1, 'active', 'single', NULL),
(30, 'VALERIANA', '', 'DE VERA', '', 'valeriana@yahoo.com', '#97 BF Aquino Ave., Baliuag, Bulacan', NULL, NULL, 'CL1 - Bulacan', 0, 5, 2, 'active', 'single', NULL),
(31, 'MARY IMMACULATE & GENERAL HOSPITAL', '', '', '', 'maryimmgenhosp@yahoo.com', 'Malolos Bulacan (near Santos General Hospital)', NULL, NULL, 'CL1 - Bulacan', 0, 5, 2, 'active', 'single', NULL),
(32, 'DRA. LANI', '', 'MANIPULA', '', 'lanimanipula@yahoo.com', 'Cagayan Valley Rd., Tibag, Baliuag, Bulacan', NULL, NULL, 'CL1 - Bulacan', 0, 5, 2, 'active', 'single', NULL),
(33, 'DRA. JAMAINE', '', 'NICOLAS', '', 'jamainenicolas@yahoo.com', 'BS Aquino Ave., Cangos, Baliuag, Bulacan', NULL, NULL, 'CL1 - Bulacan', 0, 5, 2, 'active', 'single', NULL),
(34, 'DRA. MA. ELENA', '', 'SAYO', '', 'elenasayo@yahoo.com', 'Malolos, Bulacan', NULL, NULL, 'CL1 - Bulacan', 0, 5, 2, 'active', 'single', NULL),
(35, 'RUGAY MATERNITY & GENERAL HOSPITAL', '', '', '', 'rugayhospital@yahoo.com', 'Sabang Carpa, Baliuag, Bulacan', NULL, NULL, 'CL1 - Bulacan', 0, 5, 2, 'active', 'single', NULL),
(36, 'CASTRO MATERNITY HOSP. & MED. CENTER INC.', '', '', '', 'castro@yahoo.com', 'M. Ponce St., Tibag, Baliuag, Bulacan', NULL, NULL, 'CL1 - Bulacan', 0, 5, 2, 'active', 'single', NULL),
(37, 'SC MARCELO HOSPITAL', '', '', '', 'marcelo@yahoo.com', 'Baliuag, Bulacan', NULL, NULL, 'CL1 - Bulacan', 0, 5, 2, 'active', 'single', NULL),
(38, 'STA. CRUZ HOSPITAL', '', '', '', 'stacruz@yahoo.com', 'Calumpit, Bulacan', NULL, NULL, 'CL1 - Bulacan', 0, 5, 2, 'active', 'single', NULL),
(39, 'ST. PAUL HOSPITAL', '', '', '', 'stpaulhospital@yahoo.com', 'Binang 2nd, Bocaue, Bulacan', NULL, NULL, 'CL1 - Bulacan', 0, 5, 2, 'active', 'single', NULL),
(40, 'DRA. DOLORES GO', '', 'MENDOZA', '', 'dra.go.mendoza@yahoo.com', 'Gil Carlos St., Baliuag, Bulacan', NULL, NULL, 'CL1 - Bulacan', 0, 5, 2, 'active', 'single', NULL),
(41, 'DRA. NERISSA', '', 'TAN', '', 'dranerisatan@yahoo.com', '1711 Paz Guevarra St., Carpa Vill, Sabang, Baliuag', NULL, NULL, 'CL1 - Bulacan', 0, 5, 2, 'active', 'single', NULL),
(42, 'NAZARENUS HOSPITAL', '', '', '', 'nazarenushospital@yahoo.com', 'Meycauayan, Bulacan', NULL, NULL, 'CL1 - Bulacan', 0, 5, 2, 'active', 'single', NULL),
(43, 'DR. JUAN GREGO', '', 'TORDESILLAS', '', 'jgtordesillas@yahoo.com', 'Meycauayan, Bulacan', NULL, NULL, 'CL1 - Bulacan', 0, 5, 2, 'active', 'single', NULL),
(44, 'MENDOZA GENERAL HOSPITAL', '', '', '', 'mendozagenhosp@yahoo.com', 'P. Santiago St., Poblacion, Sta. Maria, Bulacan', NULL, NULL, 'CL1 - Bulacan', 0, 5, 2, 'active', 'single', NULL),
(45, 'GALVEZ HOSPITAL', '', '', '', 'galvezhospital@yahoo.com', 'Maharlika Hi-way San Ildefonzo, Bulacan', NULL, NULL, 'CL1 - Bulacan', 0, 5, 2, 'active', 'single', NULL),
(46, 'SANTOS GENERAL HOSPITAL', '', '', '', 'santosgenhospital@yahoo.com', 'Malolos, Bulacan', NULL, NULL, 'CL1 - Bulacan', 0, 5, 2, 'active', 'single', NULL),
(47, 'DIVINE MERCY HOSPITAL', '', '', '', 'divinemercyhosp@yahoo.com', 'McArthur Hi-way, Anupul, Bamban, Tarlac', 'Annalyn Vistan', NULL, 'CL4 -Tarlac', 0, 5, 2, 'active', 'single', NULL),
(48, 'TALON GENERAL HOSPITAL', '', '', '', 'talongenhosp@yahoo.com', 'F. Tañedo St., Tarlac City', 'Irene Zabala', NULL, 'CL4 -Tarlac', 0, 5, 2, 'active', 'single', NULL),
(49, 'DR. CHRISTIAN', '', 'SOLANO', '', 'chrissolano@yahoo.com', 'Gerona, Tarlac', NULL, NULL, 'CL4 -Tarlac', 0, 5, 2, 'active', 'single', NULL),
(50, 'RAMOS GENERAL HOSPITAL', '', '', '', 'ramosgenhosp@yahoo.com', 'Hilario St., Brgy. Ligtasan, Tarlac City', NULL, NULL, 'CL4 -Tarlac', 0, 5, 2, 'active', 'single', NULL),
(51, 'DRA. JESSLIN', '', 'TAYAG', '', 'jesslintayag@yahoo.com', 'Back of Capas Public Market, Capas, Tarlac', NULL, NULL, 'CL4 -Tarlac', 0, 5, 2, 'active', 'single', NULL),
(52, 'DR. JESUCHITO', '', 'SANTOS', '', 'jesuchitosantos@yahoo.com', 'Immaculate Concepcion Polyclinic Hospital - Concep', NULL, NULL, 'CL4 -Tarlac', 0, 5, 2, 'active', 'single', NULL),
(53, 'DR. OLIVER', '', 'ATANACIO', '', 'oliveratanacio@yahoo.com', 'CLDH Hospital Drive, San Vicente, Tarlac City', NULL, NULL, 'CL4 -Tarlac', 0, 5, 2, 'active', 'single', NULL),
(54, 'DR. JOSELITO', '', 'ESPINOSA', '', 'joselitoespinosa@yahoo.com', 'F. Tañedo St., Tarlac City - 3RD Flr.-TalonGenHosp', NULL, NULL, 'CL4 -Tarlac', 0, 5, 2, 'active', 'single', NULL),
(55, 'L.A. PASCUAL DRUGSTORE', '', '', '', 'lapascualds@yahoo.com', 'Moncada, Tarlac', NULL, NULL, 'CL4 -Tarlac', 0, 5, 2, 'active', 'single', NULL),
(56, 'LHEICARL PHARMACY', '', '', '', 'lheicarlpharmacy@yahoo.com', 'Tañedo St., Tarlac City', NULL, NULL, 'CL4 -Tarlac', 0, 5, 2, 'active', 'single', NULL),
(57, 'DRA. SHEILA', '', 'CARANTO', '', 'sheilacaranto@yahoo.com', 'Paniqui, Tarlac', NULL, NULL, 'CL4 -Tarlac', 0, 5, 2, 'active', 'single', NULL),
(58, 'DR. EUTIQUIO', '', 'ATANACIO', '', 'eutiquioatanacio@yahoo.com', 'DEAMH, San Nicolas Poblacion, Concepcion, Tarlac', NULL, NULL, 'CL4 -Tarlac', 0, 5, 2, 'active', 'single', NULL),
(59, 'ALDION DRUGSTORE', '', '', '', 'aldionds@yahoo.com', '288 Gen. Luna St., Concepcion, Malabon City', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(60, 'BOTIKA NG BARANGAY c/o Remy Suaco', '', '', '', 'botikangbrgy@yahoo.com', 'Lithanco Health Center - HBPN Lithanco St., Navotas City', 'Remy Suaco', NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(61, 'BERMUDEZ POLYMEDIC HOSPITAL', '', '', '', 'bermudezplymdc@yahoo.com', 'Malaria, Caloocan City', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(62, 'CATEQUISTA CLINIC', '', '', '', 'catequista@yahoo.com', 'B28 L24 Phase 1 Bagong Silang, Caloocan City', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(63, 'DITON PHARMACY', '', '', '', 'diton@yahoo.com', '405 Cor. Apahap St., NBBS, Navotas', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(64, 'HJS-GMMCC c/o Dra. Sonia Silonga', '', '', '', 'hjsgmmcc@yahoo.com', 'Blk 26 Lot 1 Phase 1-A Kapitbahayanan, Navotas City', 'Dra. Sonia Silonga', NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(65, 'IRMA', '', 'CAPATI', '', 'irmacapati@yahoo.com', 'Karuhatan, Valenzuela City', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(66, 'JUN', '', 'GIONSON', '', 'jungionson@yahoo.com', 'Helic Navotas, Naval St., Navotas', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(67, 'JUVAN PHARMACY', '', '', '', 'juvanpharmacy@yahoo.com', '43 M.H Del Pilar, Tugatog, Malabon', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(68, 'KAREN', '', 'LOPEZ', '', 'karenlopez@yahoo.com', 'Marulas, Valenzuela City', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(69, 'KL DRUGSTORE', '', '', '', 'kldrugstore@yahoo.com', '2010 Italiana Commercial Complex, Dalandanan, Valenzuela City', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(70, 'MALABON POLYCLINIC I', '', '', '', 'malabonplyclnc@yahoo.com', '166 Gov. Pascual St., Tugatog, Malabon', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(71, 'MARIE', '', 'VILLARUIZ', '', 'marievillaruiz@yahoo.com', '10th Ave., Caloocan City', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(72, 'MARVAL PHARMACY', '', '', '', 'marvalpharmacy@yahoo.com', '419 A. Mabini Cor. Haduratan, Caloocan City', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(73, 'NEW MABINI DRUGSTORE', '', '', '', 'newmabinids@yahoo.com', '409 A. Mabini St., Caloocan City', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(74, 'NODADO GENERAL HOSPITAL', '', '', '', 'nodadogenhosp@yahoo.com', 'Area-A Camarin North Caloocan City', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(75, 'NORTH CALOOCAN DOCTOR''S HOSPITAL', '', '', '', 'ncdh@yahoo.com', 'Bankers''s Village II - Quirino Hi-way Caloocan City', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(76, 'PAGAMUTAN BAYAN NG MALABON', '', '', '', 'pagamutanngmalabon@yahoo.com', 'Dagat-dagatan Ave., Malabon Ciy', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(77, 'POLYCARE CLINIC c/o Dra. Lourdes Redulla', '', '', '', 'polycareclinic@yahoo.com', 'Dagat-dagatan Ave., Caloocan City', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(78, 'QUEEN FAITH MEDICAL CLINIC', '', '', '', 'queenfaith@yahoo.com', 'Gen. Luna St., Concepcion, Malabon', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(79, 'REMY', '', 'SUACO', '', 'remysuaco@yahoo.com', 'Lithanco Health Center - HBPN Lithanco St., Navotas', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(80, 'RITCHIE', '', 'OBLEPIAS', '', 'ritchieoblepias@yahoo.com', '373 Lapu-lapu St., NBPN, Navotas', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(81, 'ST. JUDE MEDICAL CLINIC', '', '', '', 'stjudemedclinic@yahoo.com', 'Dagat-dagatan Ave., Caloocan City', 'Maria Fe Cruz', '381-9534', 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(82, 'ST. VIANNCY DRUGSTORE', '', '', '', 'stvianncyds@yahoo.com', '400 Edsa Caloocan City', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(83, 'V. TONG MEDICAL CLINIC', '', '', '', 'vtongmedicalclinic@yahoo.com', '267 C. Arellano Cor. Borja St., Baritan Malabon', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(84, 'DR. RAMON MARTIN', '', 'ALLEJE', '', 'ramonmartinalleje@yahoo.com', 'Island Doctors Clinic - Felicidad St., Brgy. 1 Coron Palawan', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(85, 'DR. EDMUNDO', '', 'ARALAR', '', 'edmundoaralar@yahoo.com', 'KMIA Medical & Dental Supplies, #219 Malvar St., PTO. Pricesa Palawan', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(86, 'DR. ROMULO', '', 'ARANJUEZ', '', 'romuloaranjuez@yahoo.com', '612 Governor Pascual, San Roque, Navotas', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(87, 'DR. TITO', '', 'BABIERA', '', 'titobabiera@yahoo.com', 'Phase 4 Blk 78 Lot 2 Bagong Silang, North Caloocan City', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(88, 'DR. LYNMAN', '', 'BACOLOR', '', 'lynmanbacolor@yahoo.com', '14 Kingswood St., Brixtonville Subd., Camarin North Caloocan', 'Shermaine Madriaga', '09484667527', 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(89, 'DRA. GERLYN', '', 'BONDOC', '', 'gerlynbondoc@yahoo.com', 'Mc Arthur Hi-way Mountain Heighs Caloocan City', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(90, 'DRA. MARISOL', '', 'CRUZ', '', 'marisolcruz@yahoo.com', '270 Mc Arhur Hi-way, Karuhatan, Valenzuela City', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(91, 'DRA. MA. THERESA', '', 'CRUZ', '', 'matheresacruz@yahoo.com', 'Km. 14 Mc Arthur Hi-way, Valenzuela City', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(92, 'DRA. DIONETTE FRANCIS', '', 'DARIO', '', 'dionettefrancisdario@yahoo.com', '335 Alfonso Clinic, Malvar St., Puerto Princesa City Palawan', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(93, 'DR. ERIC', '', 'DAVID', '', 'ericdavid@yahoo.com', 'Bangus St., North Bay Blvd. NBPN Navotas', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(94, 'DR. DANIEL', '', 'DE LEON', '', 'danieldeleon@yahoo.com', 'Moreno Subd. Poblacion, Brookes PTO Princesa Palawan', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(95, 'ANALIZA', '', 'ESGUERRA', '', 'analizaesguerra@yahoo.com', '563 A. Mabini Sangandaan, Caloocan City', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(96, 'DR. VINCE', '', 'IGNACIO', '', 'vinceignacio@yahoo.com', '184 Gen. Luna Cor., Herrera St., Ibaba, Malabon City', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(97, 'DR. ANTHONY', '', 'LINTAG', '', 'anthonylintag@yahoo.com', 'Medicare Hospital, Roxas, Palawan', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(98, 'DR. POLY', '', 'MANJARES', '', 'polymanjares@yahoo.com', 'Novaliches, Quezon City', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(99, 'DR. WILFREDO', '', 'MARQUEZ', '', 'wilfredomarquez@yahoo.com', 'Dagat-dagatan Ave., Malabon', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(100, 'DRA. VIVIAN', '', 'MATIAS (Good Place Pharmacy)', '', 'vivianmatias@yahoo.com', 'Phase 9 Brgy Bagong Silang Caloocan City', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(101, 'DRA. VIVIAN ', '', 'MATIAS (Matias Polyclinic)', '', 'vivianmatias@yahoo.com', 'Phase 9 Brgy Bagong Silang Caloocan City', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(102, 'DRA. IDA', '', 'MEDEL', '', 'idamedel@yahoo.com', 'Phase 4, Blk 34, Lot 27 Bagong Silang, North Caloocan', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(103, 'DRA. JOCELYN', '', 'PARK', '', 'jocelynpark@yahoo.com', '2nd Flr Bonifacio Market Caloocan City', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(104, 'DRA. EVANGELINE', '', 'REGERO', '', 'evangelineregero@yahoo.com', 'Bagong Silang Phase 5 Caloocan City', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(105, 'DRA. ELENITA', '', 'SANTOS c/o Sir Joven Aloquin', '', 'elenitasantos@yahoo.com', 'Palawan Medical City Brgy. San Pedro, Puerto Princesa City Palawan', 'Joven Aloquin', NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(106, 'DRA. HERMINIA', '', 'STA. ANA', '', 'herminiastaana@yahoo.com', '66 Pilar Morning Breeze, Caloocan City', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(107, 'DR. PANFILO', '', 'SOLANO', '', 'panfilosolano@yahoo.com', '42 Fili St., Sangandaan, Caloocan', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(108, 'DRA. TERESA', '', 'TOREJA', '', 'teresatoreja@yahoo.com', 'P-01 Bangus St., North Bay Blvd. NBPN, Navotas', NULL, NULL, 'CL5 - CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(109, 'KRISTIAN PAUL', '', 'ATIENZA', 'paulatienza', 'paulatienza@email.com', NULL, NULL, NULL, 'SL3 - Batangas1', 0, 6, 1, 'active', 'single', NULL),
(111, 'JANE', '', 'MORILLO', 'janemorillo', 'janemorillo@email.com', NULL, NULL, NULL, 'SL1 - Cavite', 0, 6, 1, 'active', 'single', NULL);
