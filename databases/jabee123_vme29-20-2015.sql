...
--
-- Host: localhost
-- Generation Time: Sep 19, 2015 at 11:42 AM
...
INSERT INTO `ar_old` (`ar_old_id`, `dr_date`, `dr_num`, `amount`, `client_id`) VALUES
(8, '2012-03-26', '18382', '249.60', 61),
(9, '2012-03-26', '18383', '1740', 61),
(10, '2012-04-19', '18672', '7900', 61),
(11, '2011-05-04', '14943', '3642.40', 60),
(14, '2014-02-13', '21974', '1911', 87),
(15, '2014-03-06', '22247', '1365', 96),
(16, '2011-03-28', '14450', '1100', 99),
(17, '2012-04-25', '18784', '919.60', 101),
(18, '2012-04-25', '18785', '4870', 101),
(19, '2011-03-02', '13990', '1728', 79),
(20, '2014-02-10', '21924', '2415', 64),
(21, '2014-02-05', '21883', '11798.50', 74),
(22, '2014-02-22', '22090', '6440', 92),
(23, '2014-02-19', '22050', '3750', 97),
(24, '2014-02-22', '22091', '17280', 105);
...
(25, 'JEROME', '', 'VALERIO', 'jeromevalerio', 'jeromevalerio@email.com', NULL, NULL, NULL, 'Pangasinan', 0, 6, 3, 'active', 'single', NULL),
(26, 'MILLISCENT', 'BITANGCOL', 'DALUSONG', 'milly', 'milliscent.bitangcol@yahoo.com', NULL, NULL, NULL, 'Nueva Ecija', 550000, 6, 2, 'active', 'single', NULL),
(27, 'CHERRYL ANNE', 'GAZA', 'ALBERTO', 'anne', 'annalberto04@gmail.com', NULL, NULL, NULL, 'Pampanga', 550000, 6, 2, 'active', 'single', NULL),
...
(59, 'ALDION DRUGSTORE', '', '', '', 'aldionds@yahoo.com', '288 Gen. Luna St., Concepcion, Malabon City', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(60, 'BOTIKA NG BARANGAY c/o Remy Suaco', '', '', '', 'botikangbrgy@yahoo.com', 'Lithanco Health Center - HBPN Lithanco St., Navotas City', 'Remy Suaco', NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(61, 'BERMUDEZ POLYMEDIC HOSPITAL', '', '', '', 'bermudezplymdc@yahoo.com', 'Malaria, Caloocan City', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(62, 'CATEQUISTA CLINIC', '', '', '', 'catequista@yahoo.com', 'B28 L24 Phase 1 Bagong Silang, Caloocan City', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(63, 'DITON PHARMACY', '', '', '', 'diton@yahoo.com', '405 Cor. Apahap St., NBBS, Navotas', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(64, 'HJS-GMMCC c/o Dra. Sonia Silonga', '', '', '', 'hjsgmmcc@yahoo.com', 'Blk 26 Lot 1 Phase 1-A Kapitbahayanan, Navotas City', 'Dra. Sonia Silonga', NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(65, 'IRMA', '', 'CAPATI', '', 'irmacapati@yahoo.com', 'Karuhatan, Valenzuela City', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(66, 'JUN', '', 'GIONSON', '', 'jungionson@yahoo.com', 'Helic Navotas, Naval St., Navotas', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(67, 'JUVAN PHARMACY', '', '', '', 'juvanpharmacy@yahoo.com', '43 M.H Del Pilar, Tugatog, Malabon', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(68, 'KAREN', '', 'LOPEZ', '', 'karenlopez@yahoo.com', 'Marulas, Valenzuela City', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(69, 'KL DRUGSTORE', '', '', '', 'kldrugstore@yahoo.com', '2010 Italiana Commercial Complex, Dalandanan, Valenzuela City', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(70, 'MALABON POLYCLINIC I', '', '', '', 'malabonplyclnc@yahoo.com', '166 Gov. Pascual St., Tugatog, Malabon', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(71, 'MARIE', '', 'VILLARUIZ', '', 'marievillaruiz@yahoo.com', '10th Ave., Caloocan City', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(72, 'MARVAL PHARMACY', '', '', '', 'marvalpharmacy@yahoo.com', '419 A. Mabini Cor. Haduratan, Caloocan City', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(73, 'NEW MABINI DRUGSTORE', '', '', '', 'newmabinids@yahoo.com', '409 A. Mabini St., Caloocan City', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(74, 'NODADO GENERAL HOSPITAL', '', '', '', 'nodadogenhosp@yahoo.com', 'Area-A Camarin North Caloocan City', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(75, 'NORTH CALOOCAN DOCTOR''S HOSPITAL', '', '', '', 'ncdh@yahoo.com', 'Bankers''s Village II - Quirino Hi-way Caloocan City', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(76, 'PAGAMUTAN BAYAN NG MALABON', '', '', '', 'pagamutanngmalabon@yahoo.com', 'Dagat-dagatan Ave., Malabon Ciy', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(77, 'POLYCARE CLINIC c/o Dra. Lourdes Redulla', '', '', '', 'polycareclinic@yahoo.com', 'Dagat-dagatan Ave., Caloocan City', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(78, 'QUEEN FAITH MEDICAL CLINIC', '', '', '', 'queenfaith@yahoo.com', 'Gen. Luna St., Concepcion, Malabon', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(79, 'REMY', '', 'SUACO', '', 'remysuaco@yahoo.com', 'Lithanco Health Center - HBPN Lithanco St., Navotas', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(80, 'RITCHIE', '', 'OBLEPIAS', '', 'ritchieoblepias@yahoo.com', '373 Lapu-lapu St., NBPN, Navotas', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(81, 'ST. JUDE MEDICAL CLINIC', '', '', '', 'stjudemedclinic@yahoo.com', 'Dagat-dagatan Ave., Caloocan City', 'Maria Fe Cruz', '381-9534', 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(82, 'ST. VIANNCY DRUGSTORE', '', '', '', 'stvianncyds@yahoo.com', '400 Edsa Caloocan City', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(83, 'V. TONG MEDICAL CLINIC', '', '', '', 'vtongmedicalclinic@yahoo.com', '267 C. Arellano Cor. Borja St., Baritan Malabon', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(84, 'DR. RAMON MARTIN', '', 'ALLEJE', '', 'ramonmartinalleje@yahoo.com', 'Island Doctors Clinic - Felicidad St., Brgy. 1 Coron Palawan', NULL, NULL, 'CAMANAVA - PALAWAN', 0, 5, 2, 'active', 'single', NULL),
(85, 'DR. EDMUNDO', '', 'ARALAR', '', 'edmundoaralar@yahoo.com', 'KMIA Medical & Dental Supplies, #219 Malvar St., PTO. Pricesa Palawan', NULL, NULL, 'CAMANAVA - PALAWAN', 0, 5, 2, 'active', 'single', NULL),
(86, 'DR. ROMULO', '', 'ARANJUEZ', '', 'romuloaranjuez@yahoo.com', '612 Governor Pascual, San Roque, Navotas', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(87, 'DR. TITO', '', 'BABIERA', '', 'titobabiera@yahoo.com', 'Phase 4 Blk 78 Lot 2 Bagong Silang, North Caloocan City', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(88, 'DR. LYNMAN', '', 'BACOLOR', '', 'lynmanbacolor@yahoo.com', '14 Kingswood St., Brixtonville Subd., Camarin North Caloocan', 'Shermaine Madriaga', '09484667527', 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(89, 'DRA. GERLYN', '', 'BONDOC', '', 'gerlynbondoc@yahoo.com', 'Mc Arthur Hi-way Mountain Heighs Caloocan City', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(90, 'DRA. MARISOL', '', 'CRUZ', '', 'marisolcruz@yahoo.com', '270 Mc Arhur Hi-way, Karuhatan, Valenzuela City', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(91, 'DRA. MA. THERESA', '', 'CRUZ', '', 'matheresacruz@yahoo.com', 'Km. 14 Mc Arthur Hi-way, Valenzuela City', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(92, 'DRA. DIONETTE FRANCIS', '', 'DARIO', '', 'dionettefrancisdario@yahoo.com', '335 Alfonso Clinic, Malvar St., Puerto Princesa City Palawan', NULL, NULL, 'CAMANAVA - PALAWAN', 0, 5, 2, 'active', 'single', NULL),
(93, 'DR. ERIC', '', 'DAVID', '', 'ericdavid@yahoo.com', 'Bangus St., North Bay Blvd. NBPN Navotas', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(94, 'DR. DANIEL', '', 'DE LEON', '', 'danieldeleon@yahoo.com', 'Moreno Subd. Poblacion, Brookes PTO Princesa Palawan', NULL, NULL, 'CAMANAVA - PALAWAN', 0, 5, 2, 'active', 'single', NULL),
(95, 'ANALIZA', '', 'ESGUERRA', '', 'analizaesguerra@yahoo.com', '563 A. Mabini Sangandaan, Caloocan City', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(96, 'DR. VINCE', '', 'IGNACIO', '', 'vinceignacio@yahoo.com', '184 Gen. Luna Cor., Herrera St., Ibaba, Malabon City', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(97, 'DR. ANTHONY', '', 'LINTAG', '', 'anthonylintag@yahoo.com', 'Medicare Hospital, Roxas, Palawan', NULL, NULL, 'CAMANAVA - PALAWAN', 0, 5, 2, 'active', 'single', NULL),
(98, 'DR. POLY', '', 'MANJARES', '', 'polymanjares@yahoo.com', 'Novaliches, Quezon City', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(99, 'DR. WILFREDO', '', 'MARQUEZ', '', 'wilfredomarquez@yahoo.com', 'Dagat-dagatan Ave., Malabon', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(100, 'DRA. VIVIAN', '', 'MATIAS (Good Place Pharmacy)', '', 'vivianmatias@yahoo.com', 'Phase 9 Brgy Bagong Silang Caloocan City', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(101, 'DRA. VIVIAN ', '', 'MATIAS (Matias Polyclinic)', '', 'vivianmatias@yahoo.com', 'Phase 9 Brgy Bagong Silang Caloocan City', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(102, 'DRA. IDA', '', 'MEDEL', '', 'idamedel@yahoo.com', 'Phase 4, Blk 34, Lot 27 Bagong Silang, North Caloocan', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(103, 'DRA. JOCELYN', '', 'PARK', '', 'jocelynpark@yahoo.com', '2nd Flr Bonifacio Market Caloocan City', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(104, 'DRA. EVANGELINE', '', 'REGERO', '', 'evangelineregero@yahoo.com', 'Bagong Silang Phase 5 Caloocan City', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(105, 'DRA. ELENITA', '', 'SANTOS c/o Sir Joven Aloquin', '', 'elenitasantos@yahoo.com', 'Palawan Medical City Brgy. San Pedro, Puerto Princesa City Palawan', 'Joven Aloquin', NULL, 'CAMANAVA - PALAWAN', 0, 5, 2, 'active', 'single', NULL),
(106, 'DRA. HERMINIA', '', 'STA. ANA', '', 'herminiastaana@yahoo.com', '66 Pilar Morning Breeze, Caloocan City', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(107, 'DR. PANFILO', '', 'SOLANO', '', 'panfilosolano@yahoo.com', '42 Fili St., Sangandaan, Caloocan', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(108, 'DRA. TERESA', '', 'TOREJA', '', 'teresatoreja@yahoo.com', 'P-01 Bangus St., North Bay Blvd. NBPN, Navotas', NULL, NULL, 'CAMANAVA', 0, 5, 2, 'active', 'single', NULL),
(109, 'KRISTIAN PAUL', '', 'ATIENZA', 'paulatienza', 'paulatienza@email.com', NULL, NULL, NULL, 'Batangas1', 0, 6, 1, 'active', 'single', NULL),
(111, 'JANE', '', 'MORILLO', 'janemorillo', 'janemorillo@email.com', NULL, NULL, NULL, 'Cavite', 0, 6, 1, 'active', 'single', NULL);
...
--
-- Indexes for table `acknowledgement_reciept`
--
ALTER TABLE `acknowledgement_reciept`
...
--
-- Indexes for table `ar_old`
--
ALTER TABLE `ar_old`
  ADD PRIMARY KEY (`ar_old_id`), ADD KEY `FK_ar_old_user` (`client_id`);
...
--
-- AUTO_INCREMENT for table `acknowledgement_reciept`
--
ALTER TABLE `acknowledgement_reciept`
...
--
ALTER TABLE `action`
  MODIFY `action_id` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=64;
--
-- AUTO_INCREMENT for table `ar_old`
--
ALTER TABLE `ar_old`
  MODIFY `ar_old_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=25;
--
...
--
ALTER TABLE `district`
  MODIFY `district_id` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `logs`
  MODIFY `log_id` int(250) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=326;
--
...
--
ALTER TABLE `permission`
  MODIFY `permission_id` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=129;
--
...
--
ALTER TABLE `user`
  MODIFY `user_id` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=112;
--
-- Constraints for dumped tables
--

--
-- Constraints for table `ar_old`
--
ALTER TABLE `ar_old`
ADD CONSTRAINT `FK_ar_old_user` FOREIGN KEY (`client_id`) REFERENCES `user` (`user_id`);
