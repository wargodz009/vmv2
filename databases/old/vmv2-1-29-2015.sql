...
INSERT INTO `payment` (`payment_id`, `amount`, `payment_type`, `bank`, `check_number`, `check_full_amount`, `datetime`, `datetime_collected`, `status`) VALUES
	(1, 3000, 'check', 'pnb', '120910219', '3000', '2014-08-17 10:07:19', '2014-08-17', 0),
	(2, 300, 'cash', '', '', '', '2014-09-02 02:16:46', '2014-09-02', 0);
...
CREATE TABLE IF NOT EXISTS `payment_orders` (
  ...
  CONSTRAINT `FK_payment_orders_orders` FOREIGN KEY (`orderid`) REFERENCES `orders` (`order_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_payment_orders_payment` FOREIGN KEY (`paymentid`) REFERENCES `payment` (`payment_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=latin1;

-- Dumping data for table vmv2.payment_orders: ~3 rows (approximately)
